...
---
## Energy Transfer
Energy can cross the boundaries of a closed system by:

* **Heat**: If the energy transfer is due to a temperature difference between a closed system and its surroundings
...
*  For control volumes, energy can also be transported by mass. 
